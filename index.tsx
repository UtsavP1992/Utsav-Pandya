...
class SettingsController extends LitElement {
  ...
  // FIX: Explicitly type defaultConfig to match LiveMusicGenerationConfig to resolve type incompatibility for musicGenerationMode.
...
class PromptDj extends LitElement {
  ...
  // FIX: Cast window to `any` to access the prefixed webkitAudioContext for broader browser compatibility, resolving a TypeScript error for a property not present in standard DOM typings.
